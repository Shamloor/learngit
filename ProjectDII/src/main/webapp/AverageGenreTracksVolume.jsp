    ...
    <div align="center">
        <div class="beijing1" id="top3">
            <div class="bg"id="top2">
                <p style="height: 50px;font-size:50px;-webkit-text-fill-color: rgba(57,35,92,0.3);">每种曲风的平均音轨数量模型演示</p>
            </div>
        <div class="middle1" id="top1">
            <div >
                <div class="div4">
                    <a href="AverageGenreTracksVolume" class="btn btn-primary btn-flat m-b-30 m-t-30">开始分析AverageGenreTracksVolume</a>
                </div>
            </div>
        </div>
    </div>
