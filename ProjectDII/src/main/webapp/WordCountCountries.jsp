    ...
    <div align="center">
        <div class="beijing1" id="top3">
            <div class="bg"id="top2">
                <p style="height: 50px;font-size:50px;-webkit-text-fill-color: rgba(57,35,92,0.3);">艺术家国籍统计</p>
            </div>
            <div class="middle1" id="top1">
                <div >
                    <div class="div4">
                        <a href="WordCountCountries" class="btn btn-primary btn-flat m-b-30 m-t-30">开始分析WordCountCountries</a>
                    </div>
                </div>
            </div>
        </div>
