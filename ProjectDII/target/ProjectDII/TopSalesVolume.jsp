    ...
    <div align="center">
        <div class="beijing1" id="top3">
            <div class="bg"id="top2">
                <p style="height: 50px;font-size:50px;-webkit-text-fill-color: rgba(57,35,92,0.3);">销量最好的专辑</p>
            </div>
            <div class="middle1" id="top1">
                <div >
                    <div class="div4">
                        <a href="TopSalesVolume" class="btn btn-primary btn-flat m-b-30 m-t-30">开始分析TopSalesVolume</a>
                    </div>
                </div>
            </div>
        </div>
